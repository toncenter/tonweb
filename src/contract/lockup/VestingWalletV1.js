...
const CODE_HEX = '';
...
class VestingWalletV1 extends WalletContract {
    ...
    constructor(provider, options) {
        ...
        this.methods.getLockupData = this.getLockupData.bind(this);
    ...
    createDataCell() {
        ...
        if (this.options.vestingTotalDuration === 0) throw new Error('vestingTotalDuration cant be zero');
        if (!this.options.vestingTotalDuration) throw new Error('no vestingTotalDuration');
        if (this.options.unlockPeriod === 0) throw new Error('unlockPeriod cant be zero');
        ...
        // if (!(this.options.vestingTotalAmount instanceof BN)) throw new Error('vestingTotalAmount not BN');
    ...
    async getLockupData() {
        const myAddress = await this.getAddress();
        const result = await this.provider.call2(myAddress.toString(), 'get_lockup_data');
